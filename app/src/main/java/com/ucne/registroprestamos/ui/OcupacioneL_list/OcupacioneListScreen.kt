...
@Composable
fun OcupacioneListScreen(
    onClick: () -> Unit,
    viewModel: OcupacioneListViewModel = hiltViewModel()
) {
...
fun OcupacioneList(
    ...
    LazyColumn(modifier = modifier) {
        items(ocupacione) { ocupacione ->
            OcupacioneRow(ocupacione )
        }
    }
}

@Composable
fun OcupacioneRow(ocupacione: Ocupacione) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .padding(4.dp)
